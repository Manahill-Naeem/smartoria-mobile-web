...
export default function Footer() {
  return (
    <footer className="bg-neutral-900 text-white pt-10 pb-4 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="mb-6 w-full">
            ...
            <form className="flex w-full max-w-xs">
              <input
                type="email"
                placeholder="E-mail"
                className="bg-neutral-950 border border-neutral-800 rounded-l px-4 py-2 w-full text-white placeholder:text-neutral-400 focus:outline-none"
              />
              <button
                type="submit"
                className="bg-neutral-800 rounded-r px-4 flex items-center justify-center hover:bg-neutral-700"
              >
                <span>&#8594;</span>
              </button>
            </form>
          ...
          <div className="flex space-x-4 mt-8">
            <a href="#" aria-label="Facebook" className="hover:text-neutral-400">
              <svg
                width="24"
                height="24"
                fill="none"
      ...
      <div className="max-w-7xl mx-auto mt-10 border-t border-neutral-800 pt-4 text-sm text-neutral-400 flex flex-col md:flex-row justify-between items-center gap-2">
