...
export default function OrderConfirmationPage() {
  ...
  useEffect(() => {
    // Optional: Confetti effect for a celebratory feel
    if (orderId) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      ...
      <div className="bg-white p-10 rounded-lg shadow-xl text-center max-w-lg w-full transform transition-all duration-300 scale-95 hover:scale-100">
        ...
        {orderId && (
          <p className="text-lg text-gray-600 mb-6">Your Order ID is: <span className="font-mono bg-gray-100 px-3 py-1 rounded-md text-blue-700">{orderId}</span></p>
        )}
